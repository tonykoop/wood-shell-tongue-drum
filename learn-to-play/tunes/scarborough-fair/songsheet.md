...
## Music
```
X:3 T:Scarborough Fair (D Aeolian) M:3/4 L:1/4 Q:1/4=72 K:Dmin
A | d A F | D3/2 E/ F | E2 C | D3 |
F G A | c2 A | G2 F | A3 |
(repeat for each verse)
```

## Adaptation note
The traditional Scarborough Fair is in D dorian (with B natural). This arrangement
adapts it to D natural minor (with Bb where B would appear), which fits the D Aeolian
